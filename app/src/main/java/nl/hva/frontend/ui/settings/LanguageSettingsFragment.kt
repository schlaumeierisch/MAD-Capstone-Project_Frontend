...
import nl.hva.frontend.databinding.FragmentLanguageSettingsBinding
...
class LanguageSettingsFragment : Fragment() {
    ...
    private fun initViews() {
        ...
        binding.fabAddLanguage.setOnClickListener {
            findNavController().navigate(R.id.action_settingsFragment_to_addLanguageFragment)
        }
    ...
    private fun languageItemClicked(language: Language) {
        ...
        // navigate to the next screen (advanced settings)
        findNavController().navigate(R.id.action_settingsFragment_to_settingsAdvancedFragment)
    }
}